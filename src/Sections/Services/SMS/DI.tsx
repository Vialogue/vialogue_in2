          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { title: "150+", desc: "Countries Covered" },
                ...
                <div key={i} className="bg-slate-50 border border-slate-100 rounded-[20px] p-5 shadow-sm hover:shadow-md transition-shadow duration-300">
                  <h3 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#7C3AED] to-pink-500 mb-1">
                    {stat.title}
                  </h3>
                  ...
                  {languages.map((l, index) => (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 cursor-pointer ${
                        lang === l
                          ? "bg-gradient-to-r from-[#7C3AED] to-pink-500 text-white shadow-md"
