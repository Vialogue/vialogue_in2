  ...
  return (
    <div className="relative w-full h-[400px] flex items-center justify-center font-sans mt-0 lg:-mt-10 translate-x-2 lg:translate-x-10">
      ...
      <motion.div 
        ...
        className="absolute right-[0%] lg:right-[5%] top-[5%] w-[320px] bg-white/80 backdrop-blur-xl rounded-[24px] shadow-[0_8px_30px_rgba(124,58,237,0.08)] border border-purple-100 p-5 pb-8 z-0"
      >
        ...
        <div className="flex justify-between items-start px-2 gap-4">
          ...
          <div className="flex flex-col items-center gap-3 flex-1">
            ...
            <p className="text-sm font-semibold text-brand-purple">Integration</p>
          </div>
          {/* Security */}
          <div className="flex flex-col items-center gap-3 flex-1">
      ...
      <motion.div 
        ...
        className="absolute left-[5%] lg:left-[5%] bottom-[5%] w-[380px] bg-white rounded-[24px] shadow-[0_20px_50px_rgba(124,58,237,0.15)] border border-purple-100 p-6 z-10"
      >
