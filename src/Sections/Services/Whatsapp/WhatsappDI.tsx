...
url = "https://whatsapp.vialogue.io/v1/messages"
...
const url = "https://whatsapp.vialogue.io/v1/messages";
...
uri = URI("https://whatsapp.vialogue.io/v1/messages")
...
func main() {
  ...
  cURL: `curl -X POST "https://whatsapp.vialogue.io/v1/messages" \\
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            ...
            <p className="text-lg md:text-[19px] text-slate-600 leading-relaxed font-medium mb-10">
              ...
              easy-to-use APIs so developers can integrate WhatsApp messaging quickly
              and reliably. From startups to large enterprises, our WhatsApp APIs are
            ...
            <div className="bg-[#0f172a] rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-slate-800 overflow-hidden flex flex-col h-[520px]">
              ...
              <div className="bg-[#1e293b] px-4 py-3 flex items-center justify-between border-b border-slate-800/80">
                ...
                <div className="flex items-center gap-2 text-slate-400 text-xs font-mono">
                  <Terminal size={14} />
                  <span>whatsapp_api_request.sh</span>
                </div>
