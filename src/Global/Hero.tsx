...
import SectionSwitcher from "./sectionSwitch";
...
const GlobalHero: React.FC<GlobalHeroProps> = ({
  title,
  subtitle,
  imageSrc,
  off_nav,
  ...
  return (
    <section
      ref={heroRef}
      className="w-full pt-12 sm:pt-16 lg:pt-20 px-4 sm:px-10 lg:px-20 pb-10"
    >
